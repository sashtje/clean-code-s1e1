...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="task-list__input input-text";
    ...
    deleteButtonImg.className = 'btn__photo';
...
var editTask=function(){
    ...
    //If class of the parent is .task-list__item_mode_edit
    if(containsClass){

        //switch to .task-list__item_mode_edit
    ...
    //toggle .task-list__item_mode_edit on the parent.
